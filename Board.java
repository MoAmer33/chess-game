...
public class Board 
{
    ...
    private static Position whiteKingPos = new Position(5,1);
    private static Position blackKingPos = new Position(5,8);
    private static boolean isWhiteKingInCheck = false;
    private static boolean isBlackKingInCheck = false;
    private static Position checkingPiecePos;
    ...
    {
        // Removes unused rows and columns
   ...
   //Returns the positions between two pieces
    ...
    //You can use the "equals" function that is in the Position class
                                ...
                                if (attackingDirection == attackedPieceToKingDirection) {
                                    ...
                                    if (areSpotsEmpty(positionsBetweenAttackedPieceAndKing)) {
                                        ...
                                        for (Position move : attackedPiece.getValidMoves()) {
                                          // Accounts for the position of the pinning piece
