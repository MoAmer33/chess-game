...
public class BoardGUI extends JPanel
{
    ...
    public BoardGUI(final Board board, JFrame frame){
        ...
        validate();
        changeCursor();
        moving = new Moving(this.frame ,board, this,spotWidth, spotHeight);
    ...
    public void removeLastMovePositions()
    {
        ...
        if (previousMove != null)
            // "previousMove" may be null if the array dosn't have at most 2 values
        {
    ...
    { 
                ...
                moving.getValidPosition() != null)
        {
            for (int i = 0; i < moving.getValidPositionLength(); i++)
            {
                if (moving.getValidPosition()[i].x != 0 && moving.getValidPosition()[i].y !=0)
                {
    ...
    // hides a green or a red square if mouse pull away from from a pointed spot
